...
const requiredIds = [
  ...
  "loginScreen", "loginScreenTitle", "loginScreenStatus", "loginScreenForm", "loginScreenEmail", "loginScreenPassword", "loginScreenSignIn", "loginScreenSignUp", "loginScreenForgotPassword",
...
assert.match(app, /loginScreenForm[\s\S]*SupabaseCloud\.signIn[\s\S]*loginScreenSignUp[\s\S]*SupabaseCloud\.signUp[\s\S]*loginScreenForgotPassword[\s\S]*sendPasswordReset/, "Tam ekran giriş sayfası Supabase giriş, kayıt ve şifre yenileme akışlarına bağlanmalı");
